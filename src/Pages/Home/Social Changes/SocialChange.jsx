...
import img2 from "../../../assets/Images/Home-img/Raise fund/2.webp";
        ...
        <div className="container  mx-auto">
          <div className="lg:w-[90%] mx-auto flex flex-wrap raise-fund-section pl-6">
            <div
              ...
              data-aos-delay="0"
            >
              <h1 className="text-gray-900 sm:text-[30px] text-2xl title-font font-semibold mb-4 mt-16">
                Get involved in social change in India
              </h1>

              <p className="sm:text-lg text-base mb-8 font-medium">
                Discover and donate to fundraisers or start your own
              </p>

              <div className="inline-flex gap-4">
                {/* <!-- <button className="donate-btn ">Enroll your NGO</button> -->
                <!-- <button className="white-btn ">Enroll your NGO</button> --> */}
                <a href="">
